...
<div class="wpepp-conditional-meta-box">
    ...
    <div class="wpepp-conditional-options" <?php echo 'yes' !== $enable ? 'style="display:none;"' : ''; ?>>
        ...
        <div class="wpepp-conditional-elements" <?php echo 'yes' !== $enable ? 'style="display:none;"' : ''; ?>>
            <p><strong><?php esc_html_e('Apply to:', 'wp-edit-password-protected'); ?></strong></p>
            <label>
                <input type="checkbox" name="wpepp_conditional_control_title" value="yes" <?php checked('yes', get_post_meta($post->ID, '_wpepp_conditional_control_title', true)); ?> />
                <?php esc_html_e('Post Title', 'wp-edit-password-protected'); ?>
            </label>
            <br>
            <label>
                <input type="checkbox" name="wpepp_conditional_control_featured_image" value="yes" <?php checked('yes', get_post_meta($post->ID, '_wpepp_conditional_control_featured_image', true)); ?> />
